  ...
  products: [
    {
      ...
      description: 'this demo is learning about firebase service such as [Auth Servcice, Firestore, Storage, Hosting] and how to use it in web application.',
...
const SKILLS = {
  ...
  frontend: ['NextJs', 'React', 'Svelte', 'HTML5', 'CSS3', 'Sass', 'Redux'],
  backend: ['NodeJS', 'GraphQL', 'Express'],
  database: ['Mongodb', 'Mongoose'],
  cloud: ['Firebase', 'Vercel'],
  devops: ['Vercel', 'Netlify', 'Github Action'],
  tools: ['TailwindCSS', 'Styled-Component', 'Firebase', 'Vercel'],
  other: ['Git', 'Github', 'Bitbucket', 'Jira', 'Confluence', 'Slack', 'Trello', 'Asana', 'Figma', 'Zeplin'],
};
...
export default function Home() {
  return (
    <section className="space-y-6 divide-y-2">
      ...
      <section>
        <h3 className="font-medium text-2xl my-4">My Work and Experience:</h3>
        <div className="divide-y">
          {MY_WORKS_AND_EXPERIENCE.map((work) => (
            <div key={work.company}>
              <h3 className="font-medium text-xl mb-1 mt-3 tracking-tighter">{work.company}</h3>
              ...
              <div className="grid md:grid-cols-2 grid-cols-1 gap-4 my-2 p-4">
      ...
      <section>
        <h3 className="font-medium text-2xl my-4">My Projects and Contributes:</h3>
        <div className="divide-y">
          {MY_PROJECTS.map((work) => (
            <div key={work.company}>
              ...
              <div className="grid md:grid-cols-2 grid-cols-1 gap-4 my-2 px-4">
                {work.products.map(({ title, subTitle, alt, src, description, href }) => (
                  <ImageCardWithText src={src} title={title} subTitle={subTitle} alt={alt} description={description} href={href} key={src} />
                ))}
              </div>
      ...
      <section>
        <h3 className="font-medium text-2xl my-4">Skills:</h3>
        <div className="flex gap-1 flex-wrap flex-col p-4">
          {Object.entries(SKILLS).map(([key, values]) => (
            <div key={key} className="grid grid-cols-12 h-9">
              <div className="col-span-2">{key}:</div>
              <div className="flex gap-1 flex-wrap col-span-10">
                {TechStack.filter((tech) => values?.includes(tech.alt)).map((techItem) => (
      ...
      <section>
        <h3 className="font-medium text-2xl my-4">Education:</h3>
